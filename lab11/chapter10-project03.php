         ...
         <div class="panel panel-danger spaceabove">           
           ...
           <table class="table">
             ...
             foreach ($customers as $cust) {
                echo '<tr>';
                echo '<td><a href="chapter10-project03.php?customer=' . SOME_GETTER . '">' . SOME_GETTER . '</a></td>';
                echo '<td>' . SOME_GETTER . '</td>';
                echo '<td>' . SOME_GETTER . '</td>';
                echo '<td>' . SOME_GETTER . '</td>';
                echo '<td>' . SOME_GETTER . '</td>';   
                echo '<td>' . SOME_GETTER . '</td>';  
            ...
            if ( isset($_GET['customer']) ) {  
               ...
               ?>            
                  <div class="panel panel-danger">           
                    <div class="panel-heading"><h4>Orders for <strong><?php echo SOME_GETTER; ?></strong></h4></div>
                    <table class="table">
                      <tr>
                        <th></th>
                        <th>ISBN</th>
                     ...
                     <?php foreach ($orders as $ord) { 
                        ...
                        echo '<tr>';
                        echo '<td><img src="images/book/tinysquare/' . SOME_GETTER . '.jpg"></td>';
                        echo '<td>' . SOME_GETTER . '</td>';
                        echo '<td><a href="chapter10-project03.php?isbn=' . SOME_GETTER . '">' . SOME_GETTER . '</td>';
                        echo '<td>' . SOME_GETTER . '</td>';   
                        echo '</tr>    ';  
